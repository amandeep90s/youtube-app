...
export const StudioNavbar = () => {
  return (
    <div className={cn('fixed top-0 right-0 left-0 z-50 flex h-16 items-center border-b bg-white px-2 pr-5 shadow-md')}>
      <div className={cn('flex w-full items-center gap-4')}>
        ...
        <div className={cn('flex shrink-0 items-center')}>
          ...
          <Link href="/studio" className={cn('flex items-center gap-1 px-4')}>
            <Image src="/logo.svg" alt="Youtube" height={32} width={32} className={cn('h-12 w-12')} />
